...
namespace LitchiOzonRecovery
{
    ...
    public sealed class HttpProductImagePublisherOptions
    {
        ...
        {
            string gatewayApiKey = Environment.GetEnvironmentVariable("OZON_COMMERCE_GATEWAY_API_KEY");
            return new HttpProductImagePublisherOptions
            {
                UploadUrl = FirstNonEmpty(
                    ...
                    BuildGatewayUploadUrl(gatewayApiKey),
        ...
        private static string BuildGatewayUploadUrl(string gatewayApiKey)
        {
            ...
            string gatewayBaseUrl = FirstNonEmpty(
                Environment.GetEnvironmentVariable("OZON_COMMERCE_GATEWAY_BASE_URL"),
                "http://127.0.0.1:8000");
            return gatewayBaseUrl.TrimEnd('/') + "/v1/biz/images/upload";
        }
    }
    ...
    public sealed class HttpProductImagePublisher : IProductImagePublisher
    {
        ...
        private string PostMultipart(string localImagePath)
        {
            ...
            {
                request.Headers["Authorization"] = "Bearer " + _options.GatewayApiKey.Trim();
            }
